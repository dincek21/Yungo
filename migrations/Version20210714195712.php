 ...
 */
final class Version20210714195712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario ADD gender_user VARCHAR(10) NOT NULL, CHANGE picture_user picture_user VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario DROP gender_user, CHANGE picture_user picture_user VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
